...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
maximum_blockerror=300;          % maximum blockerrors per SNR point
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         
    ...
    g204BER = BER;
    g204BLER = BLER;
    g204block_array = block_array;
    % 
    save results204Gallager2.mat g204dB g204BER g204BLER g204block_array
